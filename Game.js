class Game {
    ...
    async start(){
      ...
      athelete1.addImage("athelete1",athelete1_img);
      athelete2=createSprite(300,200);
      athelete2.addImage("athelete2",athelete2_img);
      athelete3=createSprite(500,200);
      athelete3.addImage("athelete3",athelete3_img);
      athelete4=createSprite(700,200);
      athelete4.addImage("athelete4",athelete4_img);
